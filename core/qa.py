...
# 薬機法的にリスクのある効果効能の断定表現（家電/ガジェット＋化粧品/食品/サプリで原則NG）
DEFAULT_NG_KEYWORDS = [
    "治る", "治療", "完治", "病気", "症状が改善", "効能", "医薬品", "医師が推奨",
    "ウイルスを除去", "菌を除去", "除菌効果", "痩せる", "ダイエット効果", "血行が良くなる",
    "肩こりが治", "疲労回復", "免疫力",
    # 化粧品・スキンケア・日焼け止め（消耗品開放で追加）
    "シミが消える", "シミが薄く", "シワが消える", "シワがなくなる", "美白効果",
    "アンチエイジング", "老化防止", "若返", "完全に防ぐ", "副作用なし", "肌が生まれ変わ",
    # 食品・サプリ
    "デトックス", "脂肪燃焼", "飲むだけで", "食べるだけで", "便秘が治", "血糖値を下げる",
    "コレステロールを下げる",
]
